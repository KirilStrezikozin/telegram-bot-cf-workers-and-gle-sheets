    ...
    const botReplies = new Map([
        ...
        ["about_us", new Map([
            ["ua",
                ...
                "будь-кому, хто допитливий, цікавиться історією або готується до тестів, іспитів, на льоту знаходити інформацію про події, дати та людей за допомогою простого запиту.\n\n" +
                ...
                "де ти у виграші, якщо здатен належним чином зіставляти окремі слова чи частини речень в питанні, щоб знаходити правильні відповіді та заощаджувати безліч часу для зосередження " +
                ...
                "де команди з різних класів розробляють разом щось нове й цікаве. Ми вирішили розпочати розробку Телеграм-бота.\n\n" +
                ...
                "Також те, що надзвичайно вплинуло на успіх, - це сама наша команда. Суміш з любителів історії, художника, редактора, програміста, спікера й вчителя разом доклали зусиль, " +
                ...
                "де ти зможеш поглянути ближче на те, працює бот. Якщо тобі сподобалася наша розробка і в тебе з'явилося бажання підтримати його подальшу розробку, пиши сюди: @heiskempler.\n\n" +
                "🙏 Дякую тобі за увагу!\n", 
            ],
            ["en",
